#!/usr/bin/env python3
"""
File Name: EIIHLNGR.py
Loan Extended to Non-Resident/Foreign Entities - PUBLIC ISLAMIC BANK BERHAD Version
...
OUTPUT_NON_FOREIGN_BKINST = "/mnt/user-data/outputs/ixbnkinst_report.txt"
OUTPUT_CUSTOMER_LIST = "/mnt/user-data/outputs/icust_bankinst_report.txt"
...
REPTMMMYY = reptdate.strftime('%b%y').upper()  # Added for report title
...
# Note: This version includes CCOLLNO and CGUARNAT in the distinct selection
...
# ============================================================================
# STEP 8: PREPARE CUSTOMER DETAIL LIST (CUST_OSBAL)
# ============================================================================
print("\nStep 8: Preparing customer detail list...")

# Add customer type to ln_osbal
cust_osbal = ln_osbal.copy()
cust_osbal['CUSTTYPE'] = cust_osbal['CUSTCD'].map(CUSTDESC)
print(f"Customer detail records: {len(cust_osbal):,}")


# ============================================================================
# STEP 9: ADD CUSTOMER TYPE TO SPLIT DATA
# ============================================================================
print("\nStep 9: Adding customer type descriptions...")

# Add customer type to both datasets
split_data['CUSTTYPE'] = split_data['CUSTCD'].map(CUSTDESC)


# ============================================================================
# STEP 10: SUMMARIZE FOREIGN BANKING INSTITUTIONS
# ============================================================================
print("\nStep 10: Summarizing foreign banking institutions...")
...
# ============================================================================
# STEP 11: SUMMARIZE NON-FOREIGN BANKING INSTITUTIONS
# ============================================================================
print("\nStep 11: Summarizing non-foreign banking institutions...")
...
def write_report_header(f, title1, title2, is_summary=True):
    ...
    if is_summary:
        ...
        f.write(' ')
        f.write(
            f'{"CODE":<6}{"TYPE":<50}{"GUARANTEE O/S BALANCE":>22}{"NON GUARANTEE O/S BALANCE":>28}{"TOTAL OUTSTANDING":>22}\n')
        ...
        f.write(' ')
        f.write(
            f'{"ACCTNO":<12}{"NOTENO":<10}{"PRODUCT":<10}{"BAL_AFT_EIR":>20}{"CUSTFISS":<10}{"PAIDIND":<10}{"CCOLLNO":<12}{"CGUARNAT":<10}{"GUARANTEE_IND":<15}\n')
...
# ============================================================================
# STEP 12: GENERATE FOREIGN BANKING INSTITUTIONS REPORT
# ============================================================================
print("\nStep 12: Generating foreign banking institutions report...")
...
# ============================================================================
# STEP 13: GENERATE NON-FOREIGN BANKING INSTITUTIONS REPORT
# ============================================================================
print("\nStep 13: Generating non-foreign banking institutions report...")
...
# ============================================================================
# STEP 14: GENERATE CUSTOMER DETAIL LIST REPORT
# ============================================================================
print("\nStep 14: Generating customer detail list report...")
