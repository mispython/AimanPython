...
CTCS_MON_CSV = os.path.join(OUTPUT_DIR, f"CTCS{REPTMON}.csv")        # for .csv generator
...
ctcs_out.write_csv(str(CTCS_MON_CSV))      # for .csv generator

print(f"CTCS accumulator written: {CTCS_MON_PQ}")
print(f"CTCS accumulator written: {CTCS_MON_CSV}")
