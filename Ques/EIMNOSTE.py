...
# Input paths
INPUT_MNITB_REPTDATE = INPUT_DIR / "mnitb_reptdate.parquet"     # NOT used
INPUT_WKNOST         = INPUT_DIR / "FIDSAS.txt"  # Walker file (fixed-width text)
INPUT_DPNOST         = INPUT_DIR / "NOSCBNK.parquet"  # Deposit file (fixed-width with packed decimal)

# Output paths
OUTPUT_REPTDATE     = OUTPUT_DIR / "nostro_reptdate.parquet"
