...
10. LN.LNNOTE    (JCL //LN  DD DSN=SAP.PBB.MNILN(0))
...
11. REM.REMTRAN&REPTMON&NOWK&REPTYEAR (JCL //REM DD DSN=SAP.PBB.CRM.RMTRNSAC(0))
...
12. CIS.CUSTDLY  (JCL //CIS DD DSN=RBP2.B033.CIS.CUST.DAILY)
...
# ENTITY_CD: 'PIBB' -> ILNNOTE, anything else -> LNNOTE
INPUT_LN_LNNOTE_FILE    = STG_DIR / "MNILN" / "enrh_ln_note_d08.sas7bdat"
...
OUTPUT_DIR = BASE_DIR / "output" / "EIDETFRM"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
OUTPUT_FILE      = OUTPUT_DIR / f"EIDETFRM_FOREIGN_{ts}.txt"
OUTPUT_BACKUP    = OUTPUT_DIR / f"EIDETFRM_FOREIGN_{ts}_BKP.txt"
