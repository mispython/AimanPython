...
Purpose: FD by Individual/Non-Individual by Time to Maturity for ALCO
         - Uses REMAINING MATURITY for FD classification (like RM01)
         - Only includes FD, not Savings/Current (like RM02)
         - Splits by TYPE: INDIVIDUALS vs NON-INDIVIDUALS (like RM02)
         - Combination of RM01's remaining maturity + RM02's individual split
"""
...
OUTPUT_PATH_REPORT = "EIBMRM03_REPORT.txt"
LRECL = 133
...
def process_eibmrm03():
    print("EIBMRM03 - FD by Individual/Non-Individual by REMAINING MATURITY")
    mv = get_dates()
    ...
    # FD Processing - Uses REMAINING MATURITY (like RM01) + TYPE split (like RM02)
    ...
    with open(OUTPUT_PATH_REPORT, 'w') as f:
        ...
        f.write(format_asa_line('RISK MANAGEMENT REPORT : EIBMRM03'.center(LRECL - 1)) + '\n')
