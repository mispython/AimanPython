...
LKP_BRANCH_FILE = INPUT_DIR / "LKP_BRANCH.txt"
...
# HRRG_FILE = INPUT_DIR / "RGSTAF.txt"   # DATA HRRG step commented out in SAS
...
def summarize_branch(srsbr_all: pl.DataFrame) -> pl.DataFrame:
    """
    PROC SUMMARY DATA=SRSBR NWAY;
    CLASS BRCHCD STAFF PRODUCT NCORE;
    VAR C1CNT C2CNT C3CNT C4CNT C5CNT C1BAL C2BAL C3BAL;
    OUTPUT OUT=SCRD.SRSBR (DROP=_TYPE_ _FREQ_) SUM=;
    """
