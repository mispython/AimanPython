...
# PATH SETUP
# ----------------------------------------------------------------------
BASE_DIR = Path('data/bnm/')
BRHFL_FILE = Path('data/brhfl.dat')

OUTPUT_DIR = Path('reports/')
OUTPUT_PRINT1 = OUTPUT_DIR / 'teller_consolidated.txt'
OUTPUT_PRINT2 = OUTPUT_DIR / 'teller_branch_detail.txt'
OUTPUT_BRDEMO = OUTPUT_DIR / 'branch_demo.dat'
