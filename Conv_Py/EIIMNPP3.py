...
Purpose  : Read a consolidated NPL RPS report (INFIL01), detect page headers
           ...
           This version reads SIX header lines (LINE1-LINE6) per page break,
            corresponding to EIIMNPP3 in SAS.
           The BRCHTAG = 'BRANCH=' check is wrapped in an explicit DO/END block
            (unlike NP2 which has a bare IF statement).
...
INFIL01_PATH  = os.path.join(INPUT_DIR,  "EIIMNPP3_INFIL01.txt")
OUTFIL01_PATH = os.path.join(OUTPUT_DIR, "EIIMNPP3_CAC911.txt")
OUTFIL02_PATH = os.path.join(OUTPUT_DIR, "EIIMNPP3_CAC912.txt")
OUTFIL03_PATH = os.path.join(OUTPUT_DIR, "EIIMNPP3_CAC916.txt")
OUTFIL04_PATH = os.path.join(OUTPUT_DIR, "EIIMNPP3_CAC915.txt")
OUTFIL05_PATH = os.path.join(OUTPUT_DIR, "EIIMNPP3_CAC914.txt")
OUTFIL06_PATH = os.path.join(OUTPUT_DIR, "EIIMNPP3_CAC913.txt")
OUTFIL0X_PATH = os.path.join(OUTPUT_DIR, "EIIMNPP3_COMBINED.txt")
...
#      IF BRCHTAG = 'BRANCH=' THEN DO;    ← explicit DO/END block (differs from NP2)
